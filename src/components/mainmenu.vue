<template>
    <div class="mainmenu d-none d-md-block" ref="dropdown">
        ...
        <ul class="mainmenu__list">
            <li v-for="(menuItem, index) in menuItems" :key="index" class="mainmenu__list-item mainMenuToggle">
                ...
                <div class="dropdown mainmenu__list-subitem grid-x">
...
import { onToggleMainMenu } from "@/utils/utils";
